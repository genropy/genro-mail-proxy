#!/usr/bin/env python3
"""
Example Client for gnr-async-mail-service

This standalone server demonstrates how to integrate with gnr-async-mail-service.
...
class ExampleClient:
    """
    Example client demonstrating integration with gnr-async-mail-service.
    ...
    async def create_test_message(self, custom_subject: Optional[str] = None) -> dict:
        ...
        <body>
            ...
            <p>This message demonstrates the integration pattern with gnr-async-mail-service:</p>
            <ol>
...
app = FastAPI(
    ...
    description="Demonstrates integration with gnr-async-mail-service",
    version="1.0.0"
)
...
async def proxy_sync(request: Request):
    ...
    This receives delivery confirmations from gnr-async-mail-service.
