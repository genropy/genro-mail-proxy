...
from core.mail_proxy.cli import (
    _ensure_instance,
    _generate_api_token,
...
class TestHelperFunctions:
    ...
    def test_get_instance_dir(self, tmp_path):
        ...
        with patch("core.mail_proxy.cli.Path.home", return_value=tmp_path):
...
class TestStopInstance:
    ...
    def test_stop_instance_permission_error(self, mock_kill, tmp_path):
        ...
        with patch("core.mail_proxy.cli.Path.home", return_value=tmp_path):
            ...
            with patch("core.mail_proxy.cli._is_instance_running", return_value=(True, 12345, 8000)):
